# Python 06: Functions, Dictionaries and Sets — werkblad

> Vragen uit [week 6 voorbereiding.md](./week%206%20voorbereiding.md). Vul je antwoord onder elke vraag in.
...
#### Oefening 1. Describe in your own words the difference between a `dictionary` and a `tuple`.


#### Oefening 2. Create a new dictionary containing a key named `FirstName` with the value `Larry`, a key named `LastName` with the value `Page`. Print the last value from the dictionary.


#### Oefening 3. Create a dictionary with the following pairs `"brand": "Ford", "model": "Mustang", "year": 1964`.
...
#### Oefening 4. Modify the code from the previous exercise so each value becomes a `tuple` containing two random numbers.


#### Oefening 5. Provide your solutions to the exercises of **ORef-01: Dictionary**.


#### Oefening 6. Design two exercises of your own. They should improve understanding topics of this step.


#### Oefening 7. If you don't have an IDE yet, install an IDE on your working machine. Implement and run a simple Python program of your choice.
...
#### Oefening 8. **Extra:** Provide your solutions to the exercises of **ORef-01: Dictionaries**
...
#### Oefening 1. Describe in your own words the difference between a `set` and a `tuple`.


#### Oefening 2. Describe in your own words the difference between a `set` and a `list`.


#### Oefening 3. Create a set with and fill it with some values you can think of yourself. Print the length and the last value from the set.


#### Oefening 4. Create a function which takes a `dictionary` as argument and returns a `set` created from the values of the given `dictionary`. Call the function and print all values from the returned set.


#### Oefening 5. Create a `set` containing 5 letters `x,y,q,z,u`. Ask the user the input a letter. Check with `if` statement if the given letter is inside the `set`, print `yes` or `no`.
...
#### Oefening 1. Complete the given code by creating a lambda that checks if a given number is even.
...
#### Oefening 2. Create a code snippet that splits up a list into two new lists. Depending on if the number in the list is even or odd. Accomplish this with using a lambda and knowledge from the earlier weeks.
...
#### Oefening 3. Complete the function that checks if a given list is sorted or not, use at least one lambda within the function.
...
#### Oefening 4. Create a lambda that takes two arguments and returns a Tuple containing those two values.
